...
from tasks.views import manager_dashboard,employee_dashboard,create_task,view_task,update_task,delete_task,task_details,dashboard,HiGreetings,CreateTask,ViewProject,TaskDetail
urlpatterns=[
